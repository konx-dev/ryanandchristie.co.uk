  ...
  <div className="our-story__container">
    <div className="our-story__body">
      ...
      <div className="our-story__body-copy">
        ...
        <p className="text-align-left"><span className="our-story__ryan-quote">“Let’s go down there!”</span></p> 
        <p className="text-align-right"><span className="our-story__christie-quote">“Why do you keep trying to go to these weird random places?”</span></p>
      <div> 
        ...
        <p className="text-align-left"><span className="our-story__ryan-quote">“Look at those reeds,”</span></p> 
        <p className="text-align-right"><span className="our-story__christie-quote">“We should probably get back to the bus,”</span></p> 
        ...
        <p className="text-align-right"><span className="our-story__christie-quote">“What the hell are you doing?”</span></p> 
        <p>Ryan got down on one knee, and fumbled for the ring. As the tides rolled in, and the sun smothered the horizon, Christie said yes.</p> 
      </div>
    </div>
  </div>
)
