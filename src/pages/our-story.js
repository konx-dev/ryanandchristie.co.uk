  ...
  <div className="our-story__container">
    <div className="our-story__body">
      ...
      <div className="our-story__quoteblock">
        <p className="text-align-left, our-story__ryan-quote">“Let’s go down there!”</p> 
        <p className="text-align-right, our-story__christie-quote">“Why do you keep trying to go to these weird random places?”</p>
      </div>
      <div> 
      ...
      <div className="our-story__quoteblock">
        <p className="text-align-left, our-story__ryan-quote">“Look at those reeds,”</p> 
        <p className="text-align-right, our-story__christie-quote">“We should probably get back to the bus,”</p> 
      </div>
      <div>
        ...
        <p className="text-align-right, our-story__christie-quote">“What the hell are you doing?”</p> 
